...
def main():
    ...
    opencood_validate_dataset = build_dataset(hypes,
                                              visualize=False,
                                              train=False)
    opencood_test_dataset = build_dataset(hypes,
                                              visualize=True,
                                              train=False)
    ...
    for epoch in range(init_epoch, max(epoches, init_epoch)):
        ...
        print('At epoch %d, the train loss is %f' % (epoch,
                                                            train_ave_loss))
        writer.add_scalar('Train_Loss', train_ave_loss, epoch)
        ...
        #     print('At epoch %d, the test loss is %f' % (epoch,
        #                                                       test_ave_loss))
        #     writer.add_scalar('Test_Loss', test_ave_loss, epoch)

        #     print('write all loss')
        #     try:
        #         writer.add_scalars('All_Loss', {'Train': train_ave_loss, 'Validate': valid_ave_loss, 'Test': test_ave_loss}, epoch)
        #     except:
        #         print('write scalars failed, skip')
