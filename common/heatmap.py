"""
common function related to heatmap
...
def add_rect(img, loc, ori, box, value, pixels_per_meter, max_distance, color):
    """
    Render a single perception object to BEV image in form of vectorized shapes (e.g. rectangle)
    """
...
def generate_future_waypoints(measurements, pixels_per_meter=5, max_distance=18):
    """
    Render future waypoints on BEV image, e.g. for visualization
    """
    img_size = max_distance * pixels_per_meter * 2
...
def generate_heatmap(measurements, actors_data, pixels_per_meter=5, max_distance=18):
    """
    Render a list of perception objects to BEV image in form of vectorized shapes (e.g. rectangle)
    """
    img_size = max_distance * pixels_per_meter * 2
