...
class VLMControllerSpeedCurvature(VLMControllerBase):
    ...
    def run_step(self, route_info, buffer_idx=0):
        ...
        adapt_alpha       = float(self.config.get('adapt_alpha', 1)) # Therotically, this should be 1, consider that some models make have high or low sensitivity to steering, we can adapt the steering sensitivity by this alpha.
